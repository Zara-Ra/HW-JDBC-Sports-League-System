...
public class MainHandler {
    private final Scanner scanner = AppConstant.getScanner();//ToDo when to close connection db
    ...
    private void previousLeagues() throws SQLException {
        System.out.println("---------------------------------------");
    ...
    private void teamInfo() throws SQLException {
        System.out.println("---------------------------------------");
    ...
    private void createNewLeague(Sports sportType) throws SQLException {
        System.out.println("---------------------------------------");
    ...
    private void deletTeam() throws SQLException {
        System.out.println("---------------------------------------");
