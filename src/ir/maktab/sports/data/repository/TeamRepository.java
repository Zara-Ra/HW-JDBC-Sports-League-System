...
public class TeamRepository {
    ...
    public Team findTeamByID(int ID, Sports sportType) throws SQLException {
        Team team = null;
    ...
    public List<Team> findTeamsByLeagueID(int leagueID, Sports sportType) throws SQLException {
